...
SELECT * 
FROM clientes
WHERE Pais IN ("Brazil", "MeExico") or Titulo LIKE "Sales%"; 
/*2 Obtener un listado de todos los clientes que pertenecen a una compañía que
empiece con la letra "A"*/
SELECT *
FROM clientes
WHERE Compania LIKE "A%";

/*3 Obtener un listado con los datos: Ciudad, Contacto y renombrarlo como Apellido y
Nombre, Titulo y renombrarlo como Puesto, de todos los clientes que sean de la
ciudad "Madrid".
*/
SELECT Ciudad,
...
/*5 Obtener un listado de todas las facturas con ID entre 10000 y 10500 o de los clientes
con ID que empiecen con la letra “B”.*/
SELECT *
FROM facturas
...
/*8 ¿Existen facturas con EmpleadoID del empleado del ejercicio anterior? (No
relacionar, sino verificar que existan facturas)
*/
SELECT FechaFactura
FROM facturas
WHERE ClienteID=5;
